...
2.  The launcher (via `provisionLinux.py`) will automagically grab core mini root filesystem, compile external tools, mirror the host DNS, and prepare the static container golden image at `/tmp/vessel-root-base`.
